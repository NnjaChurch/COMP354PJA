...
public class GameObserver implements Observer {
    ...
    /**
     * update is called when the observable object (the card in this case) is updated.
     * Handles the passed card and invokes the proper game logic based on the current state of the game
     * @param o is the observable object (unused)
     * @param arg is the passed card object that was updated
     */
    @Override
